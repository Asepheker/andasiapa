...
sesid = sys.argv[1]
dark = requests.post("https://id.jagreward.com/member/verify-mobile-2/{sesid}/", data={"method": "CALL", "countryCode": "id",}, headers={"PHPSESSID": "l6emhlv9jm6i0eskarkuupfl84", "User-Agent": "Mozilla/5.0 (Linux; Android 9; vivo 1902) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36",}).text
